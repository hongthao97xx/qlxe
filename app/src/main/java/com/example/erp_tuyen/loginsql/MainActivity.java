...
public class MainActivity extends Activity {
    ...
    public class DoLogin extends AsyncTask<String,String,String>
    {
        ...
        try {
                ...
                String query = "select * from Employees where Username='" + userid + "' and Password='"+password+"' ";
                //trên đây là câu truy vấn
                    ...
                    {
                        hoten=resultSet.getString("FirstName");//Hàm lấy giá trị của tên cột (trường: field name) truyền vào
        ...
        protected void onPostExecute(String r) {// sau khi tiến trình kết thúc thì sẽ gọi tới hàm này
            ...
            if(isSuccess) {//kiểm tra chủ quyền của mình có tới vị trí đánh dấu nãy không :D
                ...
                Intent intent= new Intent(MainActivity.this, M2Activity.class);//tạo ra một "gói" Intent gửi từ this đến UserActivity.class
